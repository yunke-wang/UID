...
def args_parser():
    ...
    ## Demonstration
    parser.add_argument('--c_data', type=int, default=116)
...
def irl_default_parser(args):
    ...
    """ default datasets """
    """ To reproduce results in the paper, please set c_data with 112 and 116. """
    if args.c_data == 112:  # ratip
        args.level = [1, 2, 3, 4]
        args.num_opt = 1000
        args.demo_file_size = 1000
        args.worker_num = len(args.level)
    elif args.c_data == 116:  # ratip
        args.level = [1,  2, 5, 6]
        args.num_opt = 1000
        args.demo_file_size = 1000
        args.worker_num = len(args.level)
